    ...
    with open('static/schedules.json', 'r') as jsonFile:
        ...
        for item in data['schedules']:
            ...
            try:
                ...
                if (timeSubtractor(item['time1']) == current_time) or (
                        timeSubtractor(item['time2']) == current_time) or (
                        timeSubtractor(item['time3']) == current_time) or (
                        timeSubtractor(item['time4']) == current_time) or (
                        timeSubtractor(item['time5']) == current_time) or (
                        timeSubtractor(item['time6']) == current_time) or (
                        timeSubtractor(item['time7']) == current_time) or (
                        timeSubtractor(item['time8']) == current_time):
                ...
                # Check if Deleted
                if (item['time1'] == current_time) or (item['time2'] == current_time) or (
                        item['time3'] == current_time) or (item['time4'] == current_time) or (
                        item['time5'] == current_time) or (item['time6'] == current_time) or (
                        item['time7'] == current_time) or (item['time8'] == current_time):
                    # repost
...
def submit():
    if 'loggedin' in session:
        ...
        if (form.file1.data != None and form.file1.data != '' and form.file1.data != b'') or (
                form.file2.data != None and form.file2.data != '' and form.file2.data != b'') or (
                form.file3.data != None and form.file3.data != '' and form.file3.data != b'') or (
                form.file4.data != None and form.file4.data != '' and form.file4.data != b'') or (
                form.file5.data != None and form.file5.data != '' and form.file5.data != b'') or (
                form.file6.data != None and form.file6.data != '' and form.file6.data != b'') or (
                form.file7.data != None and form.file7.data != '' and form.file7.data != b'') or (
                form.file8.data != None and form.file8.data != '' and form.file8.data != b'') or (
                form.file9.data != None and form.file9.data != '' and form.file9.data != b'') or (
                form.file10.data != None and form.file10.data != '' and form.file10.data != b''):
        ...
        if (pic1Link != None and pic1Link != '') or (pic2Link != None and pic2Link != '') or (
                pic3Link != None and pic3Link != '') or (pic4Link != None and pic4Link != '') or (
                pic5Link != None and pic5Link != '') or (pic6Link != None and pic6Link != '') or (
                pic7Link != None and pic7Link != '') or (pic8Link != None and pic8Link != '') or (
                pic9Link != None and pic9Link != '') or (pic10Link != None and pic10Link != ''):
            picturesPayload = {'pic:pictures': {'pic:picture': []}}

            if pic1Link != None and pic1Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic1Link}})

            if pic2Link != None and pic2Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic2Link}})

            if pic3Link != None and pic3Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic3Link}})

            if pic4Link != None and pic4Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic4Link}})

            if pic5Link != None and pic5Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic5Link}})

            if pic6Link != None and pic6Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic6Link}})

            if pic7Link != None and pic7Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic7Link}})

            if pic8Link != None and pic8Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic8Link}})

            if pic9Link != None and pic9Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic9Link}})

            if pic10Link != None and pic10Link != '':
                picturesPayload['pic:pictures']['pic:picture'].append(
                    {'pic:link': {'@rel': 'saved', '@href': pic10Link}})
        ...
        with open('static/schedules.json', 'r') as f:
            ...
            for item in data['schedules']:
                if item['current_ad_id'] == adID:
                    times = [item['time1'], item['time2'], item['time3'], item['time4'], item['time5'], item['time6'],
                             item['time7'], item['time8']]
